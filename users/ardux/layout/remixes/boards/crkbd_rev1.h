...
#define BIG_BETWEEN_ROW_THREE_THUMBS_NONES KC_S,           KC_LBRC, KC_RBRC, KC_RBRC,    LGUI(KC_E), LGUI(KC_E),
...
#define BIG_BETWEEN_ROW_TWO_THREE_NONES KC_NO, LGUI(KC_E), LGUI(KC_E), KC_RBRC, KC_RBRC, KC_LBRC, KC_S,
